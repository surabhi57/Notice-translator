...
class Settings(BaseSettings):
 ...
 secret_key:str='development-only-change-me'; database_url:str='sqlite:///./noticelens.db'; cors_origins:str=''; upload_dir:str='uploads'; session_cookie_secure:bool=False; tesseract_cmd:str|None=None
 @property
